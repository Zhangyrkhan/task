...
const Trash = () => {
  ...
  const [deleteRestoreTask] = useDeleteUserMutation();
  ...
  const deleteAllClick = () => {
    setType("deleteAll");
    setMsg("Вы хотите навсегда удалить все элементы?");
    setOpenDialog(true);
  };

  const restoreAllClick = () => {
    setType("restoreAll");
    setMsg("Хотите восстановить все элементы в корзине?");
    setOpenDialog(true);
  };
  ...
  const restoreClick = (id) => {
    setSelected(id);
    setType("restore");
    setMsg("Хотите восстановить выбранный элемент?");
    setOpenDialog(true);
  };
  ...
  const TableHeader = () => (
    <thead className='border-b border-gray-300'>
      <tr className='text-white  text-left'>
        ...
        <th className='py-2 line-clamp-1'>Изменен в</th>
      </tr>
    </thead>
  );
  ...
  return (
    <>
      <div className='w-full md:px-1 px-0 mb-6'>
        ...
        <div className='bg-[#212121] px-2 md:px-6 py-4 shadow-md rounded'>
